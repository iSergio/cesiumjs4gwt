            ...
            if (_csPanelAbstract == null) {
                ...
                _csPanelAbstract = new ViewerPanelAbstract(csConfiguration) {
                    ...
                    public Viewer createViewer(Element element) {
                        ...
                        _viewer.imageryLayers().layerAdded.addEventListener(new UpdateViewModel());
                        _viewer.imageryLayers().layerRemoved.addEventListener(new UpdateViewModel());
                        _viewer.imageryLayers().layerMoved.addEventListener(new UpdateViewModel());
                        return _viewer;
                    }
                };
            }
    ...
    private class MSliderListener implements SliderListener {
        ...
        public boolean onSlide(SliderEvent e) {
            ...
            if (source.getElement().getId().equalsIgnoreCase("brightness")) {
                csVPanel._csPanelAbstract.getViewer().imageryLayers().get(0).brightness = value;
                brightnessTBox.setValue("" + value);
            }
            else if (source.getElement().getId().equalsIgnoreCase("contrast")) {
                csVPanel._csPanelAbstract.getViewer().imageryLayers().get(0).contrast = value;
                contrastTBox.setValue("" + value);
            }
            else if (source.getElement().getId().equalsIgnoreCase("hue")) {
                csVPanel._csPanelAbstract.getViewer().imageryLayers().get(0).hue = value;
                hueTBox.setValue("" + value);
            }
            else if (source.getElement().getId().equalsIgnoreCase("saturation")) {
                csVPanel._csPanelAbstract.getViewer().imageryLayers().get(0).saturation = value;
                saturationTBox.setValue("" + value);
            }
            else if (source.getElement().getId().equalsIgnoreCase("gamma")) {
                csVPanel._csPanelAbstract.getViewer().imageryLayers().get(0).gamma = value;
