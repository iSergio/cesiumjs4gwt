...
public class Materials extends AbstractExample {
    ...
    private class ViewerPanel implements IsWidget {
        ...
        public void createPrimitives(Scene scene) {
            ...
            polylinePipelineOptions.positions = Cartesian3.fromDegreesArray(new double[] {
                    -110.0, 42.0,
                    -85.0, 36.0,
                    -100.0, 25.0,
                    -77.0, 12.0});
        ...
        public void applyCompositeMaterial(Primitive primitive) {
            ...
            fabric.put("materials", materials);
            fabric.put("source", new JSONString(
    ...
    public Materials(ShowcaseExampleStore store) {
        super("Materials", "Browse Cesium's built in materials and define new ones using the Fabric schema", new String[]{"Showcase", "Cesium", "3d", "Viewer"}, store);
    }
    ...
    private class MChangeHandler implements ChangeHandler {
        ...
        public void onChange(ChangeEvent changeEvent) {
            ...
            if (source.equals(commonMaterialLBox)) {
                csVPanel.toggleRectangleVisibility();
                if (value == 1) {
                    csVPanel.applyColorMaterial(rectangle);
                } else if (value == 2) {
                    csVPanel.applyImageMaterial(rectangle);
                }
            } else if (source.equals(proceduralTexturesLBox)) {
                csVPanel.toggleRectangleVisibility();
                if (value == 1) {
                    csVPanel.applyCheckerboardMaterial(rectangle);
                } else if (value == 2) {
                    csVPanel.applyDotMaterial(rectangle);
                } else if (value == 3) {
                    csVPanel.applyGridMaterial(rectangle);
                } else if (value == 4) {
                    csVPanel.applyStripeMaterial(rectangle);
                }
            } else if (source.equals(baseMaterialsLBox)) {
                csVPanel.toggleRectangleVisibility();
                if (value == 1) {
                    csVPanel.applyAlphaMapMaterial(rectangle);
                } else if (value == 2) {
                    csVPanel.applyBumpMapMaterial(rectangle);
                } else if (value == 3) {
                    csVPanel.applyDiffuseMaterial(rectangle);
                } else if (value == 4) {
                    csVPanel.applyEmissionMapMaterial(rectangle);
                } else if (value == 5) {
                    csVPanel.applyNormalMapMaterial(rectangle);
                } else if (value == 6) {
                    csVPanel.applySpecularMapMaterial(rectangle);
                }
            } else if (source.equals(miscMaterialsLBox)) {
                csVPanel.toggleWorldRectangleVisibility();
                if (value == 1) {
                    csVPanel.applyRimLightingMaterial(worldRectangle);
                } else if (value == 2) {
                    csVPanel.applyWaterMaterial(worldRectangle);
                }
            } else if (source.equals(exampleCompositeMaterialsLBox)) {
                csVPanel.toggleWorldRectangleVisibility();
                if (value == 1) {
                    csVPanel.applyCompositeMaterial(worldRectangle);
                }
            } else if (source.equals(polylineMaterialsLBox)) {
                csVPanel.togglePolylineVisibility();
                if (value == 1) {
                    csVPanel.applyPolylineArrowMaterial(polyline);
                } else if (value == 2) {
                    csVPanel.applyPolylineGlowMaterial(polyline);
                } else if (value == 3) {
                    csVPanel.applyPolylineOutlineMaterial(polyline);
                }
            }
        }
    }
