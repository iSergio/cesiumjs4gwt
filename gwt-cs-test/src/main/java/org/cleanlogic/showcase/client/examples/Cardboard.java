            ...
            if (_csPanelAbstract == null) {
                ...
                _csPanelAbstract = new ViewerPanelAbstract(csConfiguration) {
                    ...
                    public Viewer createViewer(Element element) {
                        ...
                        start = JulianDate.fromDate(JsDate.create(2015, 2, 25, 16));
                        ...
                        entity = _viewer.entities().add(entityOptions);
                        ...
                        final org.cesiumjs.cs.scene.Camera camera = _viewer.camera;
                        ...
                        _viewer.scene().preRender().addEventListener(new Scene.Listener() {
                            @Override
                        ...
                        for (int i = 0; i < numBalloons; ++i) {
                            ...
                            modelGraphicsOptions.minimumPixelSize = new ConstantProperty<>(64);
                            entityOptions.model = new ModelGraphics(modelGraphicsOptions);
                            Entity balloon = _viewer.entities().add(entityOptions);
