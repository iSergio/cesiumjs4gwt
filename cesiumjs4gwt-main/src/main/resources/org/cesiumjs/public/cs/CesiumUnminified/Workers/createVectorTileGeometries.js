...
define(['./Transforms-f5d400d6', './BoxGeometry-830ab5e6', './Matrix2-57f130bc', './Color-e385bade', './CylinderGeometry-f4e2d161', './when-4bbc8319', './EllipsoidGeometry-1178107b', './IndexDatatype-4ae6decc', './createTaskProcessorWorker', './RuntimeError-1349fdaf', './ComponentDatatype-17ffa790', './WebGLConstants-508b9636', './combine-e9466e32', './GeometryOffsetAttribute-eb3834cd', './GeometryAttribute-48d0e89b', './GeometryAttributes-7827a6c2', './VertexFormat-14204a1d', './CylinderGeometryLibrary-34ad4cbb'], (function (Transforms, BoxGeometry, Matrix2, Color, CylinderGeometry, when, EllipsoidGeometry, IndexDatatype, createTaskProcessorWorker, RuntimeError, ComponentDatatype, WebGLConstants, combine, GeometryOffsetAttribute, GeometryAttribute, GeometryAttributes, VertexFormat, CylinderGeometryLibrary) { 'use strict';
