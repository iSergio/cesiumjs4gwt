 ...
 * because it was added to a model's ModelAnimationCollection. An active
 ...
 * time. Create this by calling
 * {@link ModelAnimationCollection#add(ModelAnimationOptions)}.
 *
...
public class ModelAnimation {
   ...
   * the animation is not played again. Default: false
   */
  @JsProperty
   ...
   * example, to play a sound or start a particle system, when the animation
   * starts. This event is fired at the end of the frame after the scene is
   * rendered. Default: new Event()
   */
  @JsProperty
  public Event start;
   ...
   * example, to play a sound or start a particle system, when the animation
   * stops. This event is fired at the end of the frame after the scene is
   * rendered. Default: new Event()
   */
  @JsProperty
  public Event stop;
   ...
   * specific time relative to a playing animation. This event is fired at the end
   * of the frame after the scene is rendered. Default: new Event()
   */
  @JsProperty
  public Event update;
