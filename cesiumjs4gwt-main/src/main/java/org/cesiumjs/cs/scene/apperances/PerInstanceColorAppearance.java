...
public class PerInstanceColorAppearance extends Appearance {
  /**
   * The VertexFormat that all PerInstanceColorAppearance instances are compatible
   * with when PerInstanceColorAppearance#flat is false. This requires only a
   * position attribute.
   */
  ...
  /**
   * The VertexFormat that all PerInstanceColorAppearance instances are compatible
   * with. This requires only position and st attributes.
   */
  ...
  // /**
  // * This property is part of the Appearance interface, but is not used by
  // PerInstanceColorAppearance since a fully
  ...
  // PerInstanceColorAppearance instance, or it is
  // * set implicitly via PerInstanceColorAppearance#translucent and
   ...
   * performance cost - but it can't have less.
   */
  ...
  // PerInstanceColorAppearance, this is derived from
  // * PerInstanceColorAppearance#fragmentShaderSource,
  // PerInstanceColorAppearance#flat, and PerInstanceColorAppearance#faceForward.
  ...
  //
  // /**
  // * Creates a render state. This is not the final render state instance;
  // instead, it can contain a subset of render
