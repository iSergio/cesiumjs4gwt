...
public class PointPrimitive {
    /**
     * Gets or sets the inner color of the point. The red, green, blue, and alpha
     * values are indicated by value's red, green, blue, and alpha properties as
     * shown in Example 1. These components range from 0.0 (no intensity) to 1.0
     * (full intensity).
     */
    @JsProperty
    public Color color;
     ...
     * this point will be displayed. Default: undefined
     */
    @JsProperty
    ...
    /**
     * Gets or sets near and far scaling properties of a point based on the point's
     * distance from the camera. A point's scale will interpolate between the
     ...
     * ranges the point's scale remains clamped to the nearest bound. This scale
     * multiplies the pixelSize and outlineWidth to affect the total size of the
     * point. If undefined, scaleByDistance will be disabled.
     */
    @JsProperty
    public NearFarScalar scaleByDistance;
    /**
     * Determines if this point will be shown. Use this to hide or show a point,
     ...
     * {@link NearFarScalar#far}. Outside of these ranges the point's translucency
    ...
    /**
     * A graphical point positioned in the 3D scene, that is created and rendered
     * using a PointPrimitiveCollection. A point is created and its initial
     ...
     * when PointPrimitiveCollection#update is called. The per-pointPrimitive
     * traffic is the same regardless of how many properties were updated. If most
     * pointPrimitives in a collection need to be updated, it may be more efficient
     * to clear the collection with PointPrimitiveCollection#removeAll and add new
     * pointPrimitives instead of modifying each one.
     *
