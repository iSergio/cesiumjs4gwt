...
public class IonImageryProvider implements ImageryProvider {
   ...
   * called before IonImageryProvider#ready returns true.
   */
   ...
   * fully transparent and 1.0 representing fully opaque. Default: undefined
   */
  @JsProperty
  public float defaultAlpha;
  /**
   * The default brightness of this provider. 1.0 uses the unmodified imagery
   * color. Less than 1.0 makes the imagery darker while greater than 1.0 makes it
   * brighter. Default: undefined
   */
  @JsProperty
   ...
   * unmodified imagery color. Default: undefined
   */
   ...
   * 
   * @see TextureMagnificationFilter Default: undefined
   */
  @JsProperty
   ...
   * 
   * @see TextureMinificationFilter Default: undefined
   */
  @JsProperty
  public Number defaultMinificationFilter;
  /**
   * The default saturation of this provider. 1.0 uses the unmodified imagery
   * color. Less than 1.0 reduces the saturation while greater than 1.0 increases
   ...
   * not be called before {@link IonImageryProvider#ready} returns true.
   * Generally, a minimum level should only be used when the rectangle of the
   * imagery is small enough that the number of tiles at the minimum level is
   * small. An imagery provider with more than a few tiles at the minimum level
  ...
  /**
   * Gets the rectangle, in radians, of the imagery provided by the instance. This
   * function should not be called before {@link IonImageryProvider#ready} returns
   * true.
   */
  ...
  /**
   * Gets the tiling scheme used by the provider. This function should not be
   * called before {@link IonImageryProvider#ready} returns true.
   */
   ...
   * longitude and latitude within a tile. This function should not be called
   * before {@link IonImageryProvider#ready} returns true. This function is
   * optional, so it may not exist on all ImageryProviders.
   * 
   * @param x         The tile X coordinate.
   * @param y         The tile Y coordinate.
   * @param level     The tile level.
