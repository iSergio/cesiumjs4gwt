...
public class WebMapTileServiceImageryProvider implements ImageryProvider {
   ...
   * called before WebMapTileServiceImageryProvider#ready returns true.
   */
   ...
   * WebMapTileServiceImageryProvider#ready returns true.
   */
   ...
   * function should not be called before WebMapTileServiceImageryProvider#ready
   * returns true.
   */
   ...
   * before WebMapTileServiceImageryProvider#ready returns true.
   */
  ...
  // TODO: Examples
  /**
   * Provides tiled imagery served by
   * <a href="http://www.opengeospatial.org/standards/wmts">WMTS 1.0.0</a>
   * compliant servers. This provider supports HTTP KVP-encoded and RESTful
   * GetTile requests, but does not yet support the SOAP encoding.
   * 
   * @param options
   */
  @JsConstructor
  public WebMapTileServiceImageryProvider(WebMapTileServiceImageryProviderOptions options) {
  }
