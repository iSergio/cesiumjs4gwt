 ...
 * contain animations that target a node's transform. This class allows changing
 * a node's transform externally so animation can be driven by another source,
