...
public class TileCoordinatesImageryProvider implements ImageryProvider {
   ...
   * called before TileCoordinatesImageryProvider#ready returns true.
   */
  ...
  /**
   * An ImageryProvider that draws a box around every rendered tile in the tiling
   * scheme, and draws a label inside it indicating the X, Y, Level coordinates of
   * the tile. This is mostly useful for debugging terrain and imagery rendering
   * problems.
   */
  @JsConstructor
   ...
   * before TileCoordinatesImageryProvider#ready returns true.
   * 
   * @param x     The tile X coordinate.
   * @param y     The tile Y coordinate.
   * @param level The tile level.
