...
public class Sun {
   ...
   * to be. Zero shows just the Sun's disc without any flare. Use larger values
   * for a more pronounced flare around the Sun. Default: 1.0
   */
  @JsProperty
  public double glowFactor;
  /**
   * Determines if the sun will be shown. Default: true
   */
  @JsProperty
  public boolean show;
