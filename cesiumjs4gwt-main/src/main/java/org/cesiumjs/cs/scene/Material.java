...
public class Material {
  ...
  /**
   * When true or a function that returns true, the geometry is expected to appear
   * translucent.
   */
  @JsProperty
  public boolean translucent;
  /**
   * The material type. Can be an existing type or a new type. If no type is
   * specified in fabric, type is a GUID.
   */
  @JsProperty
  public String type;
  /**
  ...
  /**
   * A Material defines surface appearance through a combination of diffuse,
   * specular, normal, emission, and alpha components. These values are specified
   * using a JSON schema called Fabric which gets parsed and assembled into glsl
   * shader code behind-the-scenes. Check out the wiki page for more details on
   * Fabric.
   */
  @JsConstructor
  public Material() {
