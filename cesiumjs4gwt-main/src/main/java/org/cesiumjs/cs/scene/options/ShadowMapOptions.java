...
public class ShadowMapOptions {
    ...
    /**
     * Whether the shadow map is enabled. Default: true
     */
    @JsProperty
    public boolean enabled;
    /**
     * Whether the light source is a point light. Point light shadows do not use
     * cascades. Default: false
     */
    @JsProperty
    public boolean isPointLight;
    /**
     * Radius of the point light. Default: 100.0
     */
    @JsProperty
    ...
    /**
     * The number of cascades to use for the shadow map. Supported values are one
     * and four. Default: 4
     */
    @JsProperty
    public int numberOfCascades;
    /**
     * The maximum distance used for generating cascaded shadows. Lower values
     * improve shadow quality. Default: 5000.0
     */
    @JsProperty
    public double maximumDistance;
    /**
     * The width and height, in pixels, of each shadow map. Default: 2048
     */
    @JsProperty
    public int size;
    /**
    ...
    /**
     * The shadow darkness. Default: 0.3
     */
    @JsProperty
