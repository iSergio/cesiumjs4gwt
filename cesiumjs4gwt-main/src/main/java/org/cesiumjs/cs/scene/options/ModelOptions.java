...
public class ModelOptions {
    ...
    public Scene scene;
    /**
     * The condition specifying at what distance from the camera that this model
     * will be displayed.
     */
    @JsProperty
     ...
     * {@link org.cesiumjs.cs.scene.enums.ColorBlendMode#HIGHLIGHT()}.
     */
    @JsProperty
    ...
    /**
     * The silhouette color. If more than 256 models have silhouettes enabled, there
     * is a small chance that overlapping models will have minor artifacts. Default:
     * {@link Color#RED()}.
     */
    @JsProperty
