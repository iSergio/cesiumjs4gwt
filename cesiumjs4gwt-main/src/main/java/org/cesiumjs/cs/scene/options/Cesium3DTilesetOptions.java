...
public class Cesium3DTilesetOptions {
    ...
    /**
     * Optimization option. Whether to cull tiles using the union of their children
     * bounding volumes. Default: true
     */
    @JsProperty
    ...
    /**
     * When skipLevelOfDetail is true, the screen space error that must be reached
     * before skipping levels of detail. Default: 1024
     */
    @JsProperty
     ...
     * tileset. See {@link org.cesiumjs.cs.scene.Cesium3DTileset#classificationType}
     * for details about restrictions and limitations.
     */
    @JsProperty
     ...
     * attenuation based on geometric error and lighting.
     */
    @JsProperty
    public PointCloudShading pointCloudShading;
    /**
     * Scales the diffuse and specular image-based lighting from the earth, sky,
     ...
     * for this model's procedural environment map. Default: 0.5
     */
    @JsProperty
