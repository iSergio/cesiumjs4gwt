 ...
 * Scene to be highlighted. The geometry must be from a single GeometryInstance.
 * Batching multiple geometries is not yet supported. A primitive combines the
 * geometry instance with an Appearance that describes the full shading,
 * including Material and RenderState. Roughly, the geometry instance defines
 * the structure and placement, and the appearance defines the visual
