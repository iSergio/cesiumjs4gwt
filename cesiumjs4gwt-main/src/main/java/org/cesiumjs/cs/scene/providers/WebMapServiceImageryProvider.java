...
public class WebMapServiceImageryProvider implements ImageryProvider {
     ...
     * The values are as follows: service=WMS version=1.1.1 request=GetMap styles= format=image/jpeg
     */
     ...
     * This function should not be called before WebMapServiceImageryProvider#ready returns true.
     */
     ...
     * WebMapServiceImageryProvider#ready returns true.
     */
