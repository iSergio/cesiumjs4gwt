...
public class SingleTileImageryProvider implements ImageryProvider {
   ...
   * called before SingleTileImageryProvider#ready returns true.
   */
   ...
   * This function should not be called before SingleTileImageryProvider#ready
   * returns true.
   */
   ...
   * function should not be called before SingleTileImageryProvider#ready returns
   * true.
   */
   ...
   * before SingleTileImageryProvider#ready returns true.
   */
  ...
  /**
   * Provides a single, top-level imagery tile. The single image is assumed to use
   * a {@link org.cesiumjs.cs.core.GeographicTilingScheme}.
   * 
