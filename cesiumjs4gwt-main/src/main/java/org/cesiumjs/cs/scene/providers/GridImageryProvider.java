...
import org.cesiumjs.cs.scene.providers.options.GridImageryProviderOptions;

/**
 * @author Serge Silaev aka iSergio
 */
@JsType(isNative = true, namespace = "Cesium", name = "GridImageryProvider")
public class GridImageryProvider implements ImageryProvider {
    /**
     * An {@link ImageryProvider} that draws a wireframe grid on every tile with
     * controllable background and glow. May be useful for custom rendering effects
     * or debugging terrain.
     */
    @JsConstructor
    public GridImageryProvider() {
    }
     ...
     */
    @JsConstructor
    public GridImageryProvider(GridImageryProviderOptions options) {
    }
     ...
     * called before GridImageryProvider#ready returns true.
     */
     ...
     * before GridImageryProvider#ready returns true.
     *
     * @param x     The tile X coordinate.
     * @param y     The tile Y coordinate.
     * @param level The tile level.
