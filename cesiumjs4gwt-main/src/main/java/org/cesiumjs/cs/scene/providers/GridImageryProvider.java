...
public class GridImageryProvider implements ImageryProvider {
     ...
     * This function should not be called before GridImageryProvider#ready returns true.
     */
     ...
     * GridImageryProvider#ready returns true.
     */
    @JsProperty(name = "maximumLevel")
    public native int maximumLevel();
    /**
     * Gets the minimum level-of-detail that can be requested. This function should not be called before GridImageryProvider#ready
     * returns true.
     */
