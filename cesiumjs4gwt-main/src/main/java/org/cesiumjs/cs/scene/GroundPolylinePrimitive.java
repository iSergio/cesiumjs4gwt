 ...
 *
 * Only to be used with GeometryInstances containing {@link org.cesiumjs.cs.core.geometry.GroundPolylineGeometry}.
 * @author Serge Silaev aka iSergio <s.serge.b@gmail.com>
 */
@JsType(isNative = true, namespace = "Cesium", name = "GroundPolylinePrimitive")
public class GroundPolylinePrimitive {
    /**
     * When true, each geometry instance will only be pickable with {@link Scene#pick(Cartesian2)}.
     ...
     * Some appearances, like {@link org.cesiumjs.cs.scene.apperances.PolylineColorAppearance} allow giving each instance unique properties.
     * Default: undefined
     */
    @JsProperty
     ...
     * If this property is true, the primitive will be rendered the next time that {@link GroundPolylinePrimitive#update} is called.
     */
     ...
     * This only needs to be called if you are creating the GroundPolylinePrimitive synchronously.
    ...
    /**
     * Checks if the given Scene supports GroundPolylinePrimitives. GroundPolylinePrimitives require support
     ...
     * Once an object is destroyed, it should not be used; calling any function other than isDestroyed will result
