...
public class Matrix3 {
  ...
  /**
   * A 3x3 matrix, indexable as a column-major order array. Constructor parameters
   ...
   * 
   * @return The modified result parameter or a new Matrix3 instance if one was
   *         not provided.
   */
  @JsMethod
   ...
   *
   * Returns a diagonal matrix and unitary matrix such that: matrix = unitary
   * matrix * diagonal matrix * transpose(unitary matrix)
   *
   * The values along the diagonal of the diagonal matrix are the eigenvalues. The
   * columns of the unitary matrix are the corresponding eigenvectors.
   * 
   * @param matrix The matrix to decompose into diagonal and unitary matrix.
   *               Expected to be symmetric.
   * @return An object with unitary and diagonal properties which are the unitary
   ...
   * @param matrix The matrix to decompose into diagonal and unitary matrix.
   *               Expected to be symmetric.
   * @param result An object with unitary and diagonal properties which are
   *               matrices onto which to store the result.
   * @return An object with unitary and diagonal properties which are the unitary
   *         and diagonal matrices, respectively.
   */
  @JsMethod
  ...
  /**
   * Computes a Matrix3 instance representing the cross product equivalent matrix
   * of a Cartesian3 vector.
   * 
   * <pre>
   * Example: {
   *   &#64;code
   ...
   * 
   * @param quaternion the quaternion to use.
   * @param result     The object in which the result will be stored, if undefined
   ...
   * </pre>
   * 
   * @param angle The angle, in radians, of the rotation. Positive angles are
   *              counterclockwise.
   * @return The modified result parameter, or a new Matrix3 instance if one was
   *         not provided.
   */
  ...
  /**
   * Creates a Matrix3 instance from a row-major order array. The resulting matrix
  ...
  /**
   * Creates an Array from the provided Matrix3 instance. The array will be in
   * column-major order.
   * 
   * @param matrix The matrix to use.
