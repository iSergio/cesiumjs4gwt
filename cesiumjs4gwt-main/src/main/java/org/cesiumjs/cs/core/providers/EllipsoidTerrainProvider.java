...
public class EllipsoidTerrainProvider implements TerrainProvider {
  ...
  /**
   * A very simple {@link TerrainProvider} that produces geometry by tessellating
   ...
   * function should not be called before {@link EllipsoidTerrainProvider#ready}
   * returns true.
   * 
   ...
   * before {@link EllipsoidTerrainProvider#ready} returns true. The result must
