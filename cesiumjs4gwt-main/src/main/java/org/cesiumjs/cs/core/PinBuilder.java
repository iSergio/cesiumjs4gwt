...
public class PinBuilder {
   ...
   * @param color The color of the pin.
   * @param size  The size of the pin, in pixels.
   * @return The canvas element to the canvas element that represents the
   *         generated pin.
   */
  @JsMethod
  ...
  /**
   * Creates a pin with the specified text, color, and size. The text will be
   * sized to be as large as possible while still being contained completely
   * within the pin.
   * 
   ...
   * @param color The color of the pin.
   * @param size  The size of the pin, in pixels.
   * @return The canvas element or a Promise to the canvas element that represents
   *         the generated pin.
   */
  @JsMethod
