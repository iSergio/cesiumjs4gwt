...
public class PackableForInterpolation implements Packable {
  ...
  /**
   * Static interface for Packable types which are interpolated in a different
   * representation than their packed value. These methods and properties are
   * expected to be defined on a constructor function.
   */
  @JsConstructor
   ...
   */
  @JsMethod
  public static native void convertPackedArrayForInterpolation(double[] packedArray, int startingIndex,
      double[] result);
   ...
   * @return The modified result parameter or a new Object instance if one was not
   *         provided.
   */
  @JsMethod
