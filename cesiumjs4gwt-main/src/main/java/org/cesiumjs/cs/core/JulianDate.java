...
public class JulianDate {
    ...
    /**
     * Represents an astronomical Julian date, which is the number of days since
     * noon on January 1, -4712 (4713 BC). For increased precision, this class
     * stores the whole number part of the date and the seconds part of the date in
     * separate components. In order to be safe for arithmetic and represent leap
     * seconds, the date is always stored in the International Atomic Time standard
     * TimeStandard.TAI.
     */
    @JsConstructor
    public JulianDate() {
     ...
     * TimeStandard.TAI.
     *
     * @param julianDayNumber The Julian Day Number representing the number of whole
     *                        days. Fractional days will also be handled correctly.
     *                        Default: 0.
     */
    @JsConstructor
     ...
     *                        days. Fractional days will also be handled correctly.
     *                        Default: 0.
     * @param secondsOfDay    The number of seconds into the current Julian Day
     *                        Number. Fractional seconds, negative seconds and
     *                        seconds greater than a day will be handled correctly.
     *                        Default: 0.
     */
    @JsConstructor
     ...
     *                        seconds greater than a day will be handled correctly.
     *                        Default: 0.
     * @param timeStandard    The time standard in which the first two parameters
     *                        are defined. Default: {@link TimeStandard#UTC()}.
     */
    @JsConstructor
     ...
     * Returns undefined if julianDate is undefined.
     */
     ...
     * @return A negative value if left is less than right, a positive value if left
     * is greater than right, or zero if left and right are equal.
     */
     ...
     * this function to return true), the absolute value of the difference between
     * them, in seconds, must be less than epsilon.
     *
     * @param left    The first instance.
     * @param right   The second instance.
     * @param epsilon The maximum number of seconds that should separate the two
     *                instances.
     * @return true if the two dates are within epsilon seconds of each other;
     * otherwise false.
     */
    ...
    /**
     * Creates a new instance from a from an ISO 8601 date. This method is superior
     * to Date.parse because it will handle all valid formats defined by the ISO
     * 8601 specification, including leap seconds and sub-millisecond times, which
     * discarded by most JavaScript implementations.
     *
    ...
    /**
     * Compares the provided instances and returns true if left is later than right,
     * false otherwise.
     *
     * @param left  The first instance.
     * @param right The second instance.
    ...
    /**
     * Compares the provided instances and returns true if left is later than or
    ...
    /**
     * Compares the provided instances and returns true if left is earlier than
    ...
    /**
     * Compares the provided instances and returns true if left is earlier than or
     * equal to right, false otherwise.
     *
     * @param left  The first instance.
     * @param right The second instance.
    ...
    /**
     * Creates a new instance that represents the current system time. This is
     * equivalent to calling JulianDate.fromDate(new Date());.
     *
     * @return The modified result parameter or a new instance if none was provided.
     */
    ...
    /**
     * Creates a JavaScript Date from the provided instance. Since JavaScript dates
     * are only accurate to the nearest millisecond and cannot represent a leap
     * second, consider using JulianDate.toGregorianDate instead. If the provided
     * JulianDate is during a leap second, the previous second is used.
     *
     ...
     *
     * @param julianDate The date to be converted.
     * @param precision  The number of fractional digits used to represent the
     *                   seconds component. By default, the most precise
    ...
    /**
     * Computes the total number of whole and fractional days represented by the
     * provided instance.
     *
     * @param julianDate The date.
    ...
    /**
     * Compares this and the provided instance and returns true if they are equal,
     * false otherwise.
     *
     * @param right The second instance.
     * @return true if the dates are equal; otherwise, false.
    ...
    /**
     * Compares this and the provided instance and returns true if they are within
     * epsilon seconds of each other. That is, in order for the dates to be
     * considered equal (and for this function to return true), the absolute value
