...
public class Cartesian2 implements Packable {
   ...
   */
  @JsMethod
  public static native boolean equalsEpsilon(Cartesian2 left, Cartesian2 right, double relativeEpsilon,
  ...
  /**
   * Creates a Cartesian2 instance from an existing Cartesian3. This simply takes
   * the x and y properties of the Cartesian3 and drops z.
   * 
   * @param cartesian The Cartesian3 instance to create a Cartesian2 instance
   *                  from.
   * @param result    The object onto which to store the result. Optional.
   * @return The modified result parameter or a new Cartesian2 instance if one was
   *         not provided.
  ...
  /**
   * Creates a Cartesian2 instance from an existing Cartesian4. This simply takes
   * the x and y properties of the Cartesian4 and drops z and w.
   * 
   * @param cartesian The Cartesian4 instance to create a Cartesian2 instance
   *                  from.
   * @param result    The object onto which to store the result. Optional.
   * @return The modified result parameter or a new Cartesian2 instance if one was
   *         not provided.
