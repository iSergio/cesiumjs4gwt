...
public class HeadingPitchRoll {
  ...
  /**
   * A rotation expressed as a heading, pitch, and roll. Heading is the rotation
   * about the negative z axis. Pitch is the rotation about the negative y axis.
   ...
   *         one was not provided. (Returns undefined if headingPitchRoll is
   *         undefined)
   */
  @JsMethod
  ...
  /**
   * Compares the provided HeadingPitchRolls componentwise and returns true if
   ...
   */
  @JsMethod
  public static native boolean equalsEpsilon(HeadingPitchRoll left, HeadingPitchRoll right, double relativeEpsilon,
   ...
   * @param pitch   the pitch in degrees
   * @param roll    the heading in degrees
   * @param result  The object in which to store the result. If not provided, a
   ...
   * )
   * 
   * @param quaternion The quaternion from which to retrieve heading, pitch, and
   *                   roll, all expressed in radians.
   * @return The modified result parameter or a new HeadingPitchRoll instance if
  ...
  /**
   * Compares this HeadingPitchRoll against the provided HeadingPitchRoll
  ...
  /**
   * Compares this HeadingPitchRoll against the provided HeadingPitchRoll
   * componentwise and returns true if they pass an absolute or relative tolerance
  ...
  /**
   * Creates a string representing this HeadingPitchRoll in the format '(heading,
   * pitch, roll)' in radians.
   * 
   * @return A string representing the provided HeadingPitchRoll in the format
   *         '(heading, pitch, roll)'.
   */
  @Override
  @JsMethod
