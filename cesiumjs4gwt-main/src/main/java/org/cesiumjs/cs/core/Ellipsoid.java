...
public class Ellipsoid {
   ...
   * 
   * @param ellipsoid The ellipsoid to duplicate.
   * @param result    The object onto which to store the result, or undefined if a
   *                  new instance should be created. Optional.
   * @return The cloned Ellipsoid. (Returns undefined if ellipsoid is undefined)
   */
  @JsMethod
  ...
  /**
   * Computes an Ellipsoid from a Cartesian specifying the radii in x, y, and z
   * directions.
   * 
   * @param radii The ellipsoid's radius in the x, y, and z directions. Optional.
   ...
   * @return The modified result parameter or a new Ellipsoid instance if one was
   *         not provided.
   */
  @JsMethod
   ...
   * @return The modified result parameter or a new Array instance if none was
   *         provided.
   */
  @JsMethod
   ...
   * Example: {
   *   &#64;code
   *   // Create an array of Cartesians and determine their Cartographic
   *   // representation on a WGS84 ellipsoid.
   *   Cartesian3[] positions = { new Cartesian3(17832.12, 83234.52, 952313.73),
   *       new Cartesian3(17832.13, 83234.53, 952313.73), new Cartesian3(17832.14, 83234.54, 952313.73) };
  ...
  /**
   * Converts the provided cartesian to cartographic representation. The cartesian
   * is undefined at the center of the ellipsoid.
   * 
   * <pre>
   *     <{@code
   ...
   * </pre>
   * 
   * @param cartesian The Cartesian position to convert to cartographic
   *                  representation.
   * @return The modified result parameter, new Cartographic instance if none was
   *         provided, or undefined if the cartesian is at the center of the
   *         ellipsoid.
   */
  @JsMethod
   ...
   * @return The modified result parameter or a new Cartesian3 instance if none
   *         was provided.
   */
  @JsMethod
  ...
  /**
   * Compares this Ellipsoid against the provided Ellipsoid componentwise and
   ...
   * 
   * @param cartesian The Cartesian for which to to determine the geocentric
   *                  normal.
   * @return The modified result parameter or a new Cartesian3 instance if none
   *         was provided.
   */
  ...
  /**
   * Computes the normal of the plane tangent to the surface of the ellipsoid at
   * the provided position.
   * 
   * @param cartesian The Cartesian position for which to to determine the surface
   *                  normal.
   * @return The modified result parameter or a new Cartesian3 instance if none
   *         was provided.
   */
   ...
   * the provided position.
   * 
   * @param cartographic The cartographic position for which to to determine the
   *                     geodetic normal.
   * @return The modified result parameter or a new Cartesian3 instance if none
   *         was provided.
   */
  ...
  /**
   * Scales the provided Cartesian position along the geocentric surface normal so
  ...
  /**
   * Scales the provided Cartesian position along the geodetic surface normal so
   * that it is on the surface of this ellipsoid. If the position is at the center
   * of the ellipsoid, this function returns undefined.
   * 
   * @param cartesian The Cartesian position to scale.
   * @return The modified result parameter, a new Cartesian3 instance if none was
   *         provided, or undefined if the position is at the center.
   */
  @JsMethod
   ...
   * of an ellipsoid using Gauss-Legendre 10th order quadrature.
   * 
   * @param rectangle The rectangle used for computing the surface area.
   * @return The approximate area of the rectangle on the surface of this
   *         ellipsoid.
   */
  @JsMethod
  ...
  /**
   * Creates a string representing this Ellipsoid in the format '(radii.x,
   * radii.y, radii.z)'.
   * 
   * @return A string representing this ellipsoid in the format '(radii.x,
   *         radii.y, radii.z)'.
   */
  @JsMethod
   ...
   * multiplying its components by the result of Ellipsoid#radii.
   * 
   * @param position The position to transform.
   * @return The position expressed in the unscaled space. The returned instance
   *         is the one passed as the result parameter if it is not undefined, or
   *         a new instance of it is.
   */
  @JsMethod
   ...
   * 
   * @param position The position to transform.
   * @param result   The position to which to copy the result, or undefined to
   ...
   * multiplying its components by the result of Ellipsoid#oneOverRadii.
   * 
   * @param position The position to transform.
   * @return The position expressed in the scaled space. The returned instance is
   *         the one passed as the result parameter if it is not undefined, or a
   *         new instance of it is.
   */
  @JsMethod
   ...
   * @param position The position to transform.
   * @param result   The position to which to copy the result, or undefined to
   *                 create and return a new instance. Optional.
   * @return The position expressed in the scaled space. The returned instance is
   *         the one passed as the result parameter if it is not undefined, or a
   *         new instance of it is.
   * @see #oneOverRadii
