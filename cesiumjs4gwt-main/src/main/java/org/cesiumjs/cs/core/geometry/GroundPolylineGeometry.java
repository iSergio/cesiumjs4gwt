...
/**
 * A description of a polyline on terrain. Only to be used with {@link org.cesiumjs.cs.scene.GroundPolylinePrimitive}.
 *
...
public class GroundPolylineGeometry extends Geometry implements Packable {
    ...
    /**
     * A description of a polyline on terrain. Only to be used with {@link org.cesiumjs.cs.scene.GroundPolylinePrimitive}.
     * @param positions An array of Cartesian3 defining the polyline's points. Heights above the ellipsoid will be ignored.
