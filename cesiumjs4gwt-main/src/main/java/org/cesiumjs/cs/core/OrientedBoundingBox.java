...
public class OrientedBoundingBox {
  /**
   * The center of the box. Default: {@link Cartesian3#ZERO()}
   */
  public Cartesian3 center;
  /**
   * The transformation matrix, to rotate the box to the right position. Default:
   * {@link Matrix3#IDENTITY()}
   */
  public Matrix3 halfAxes;

  /**
   * Creates an instance of an OrientedBoundingBox. An OrientedBoundingBox of some
   * object is a closed and convex cuboid. It can provide a tighter bounding
   * volume than {@link BoundingSphere} or {@link AxisAlignedBoundingBox} in many
   * cases.
   * 
   * @see BoundingSphere
   ...
   *                 Equivalently, the transformation matrix, to rotate and scale
   *                 a 2x2x2 cube centered at the origin. Default:
   *                 {@link Matrix3#ZERO()}
   * @see BoundingSphere
   * @see BoundingRectangle
   */
   ...
   * position projected onto direction. If you imagine the infinite number of
   * planes with normal direction, this computes the smallest distance to the
  ...
  /**
   * Compares the provided OrientedBoundingBox componentwise and returns true if
  ...
  /**
   * Computes an instance of an OrientedBoundingBox of the given positions. This
   * is an implementation of Stefan Gottschalk's Collision Queries using Oriented
   * Bounding Boxes solution (PHD thesis). Reference:
   ...
   * </pre>
   * 
   * @param positions List of Cartesian3 points that the bounding box will
   *                  enclose.
   * @return The modified result parameter or a new OrientedBoundingBox instance
  ...
  /**
   * Computes an OrientedBoundingBox that bounds a Rectangle on the surface of an
   * Ellipsoid. There are no guarantees about the orientation of the bounding box.
   * 
   ...
   * Ellipsoid. There are no guarantees about the orientation of the bounding box.
   * 
   * @param rectangle     The cartographic rectangle on the surface of the
   *                      ellipsoid.
   * @param minimumHeight The minimum height (elevation) within the tile. Default:
   *                      0.0
   * @param maximumHeight The maximum height (elevation) within the tile. Default:
   *                      0.0
   ...
   * @return Intersect.INSIDE if the entire box is on the side of the plane the
   *         normal is pointing, Intersect.OUTSIDE if the entire box is on the
   *         opposite side, and {@link Intersect#INTERSECTING()} if the box
  ...
  /**
   * Compares this OrientedBoundingBox against the provided OrientedBoundingBox
