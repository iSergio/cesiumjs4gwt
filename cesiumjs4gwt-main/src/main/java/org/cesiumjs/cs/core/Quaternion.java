...
public class Quaternion {
  ...
  /**
   * The number of elements used to store the object into an array in its
   * interpolatable form.
   */
  @JsProperty
  ...
  /**
   * The W component. Default: 0.0
   */
  @JsProperty
  public double w;
  /**
   * The X component. Default: 0.0
   */
  @JsProperty
  public double x;
  /**
   * The Y component. Default: 0.0
   */
  @JsProperty
  public double y;
  /**
   * The Z component. Default: 0.0
   */
  @JsProperty
  public double z;

  /**
   * A set of 4-dimensional coordinates used to represent rotation in
   * 3-dimensional space.
   */
  @JsConstructor
  public Quaternion() {
   ...
   * @return The modified result parameter or a new Quaternion instance if one was
   *         not provided. (Returns undefined if quaternion is undefined)
   */
  @JsMethod
  ...
  /**
   * Computes an inner quadrangle point. This will compute quaternions that ensure
   * a squad curve is C1.
   * 
   ...
   * @param result The object onto which to store the result.
   * @return The modified result parameter.
   * @see #squad(Quaternion, Quaternion, Quaternion, Quaternion, float,
   *      Quaternion)
   */
  @JsMethod
  public static native Quaternion computeInnerQuadrangle(Quaternion q0, Quaternion q1, Quaternion q2,
      Quaternion result);
   ...
   * 
   * @param packedArray   The packed array.
   * @param startingIndex The index of the first element to be converted. Default:
   *                      0
   * @param lastIndex     The index of the last element to be converted. Default:
   *                      packedArray.length
   * @param result        The object into which to store the result.
   */
  public static native void convertPackedArrayForInterpolation(double[] packedArray, int startingIndex, int lastIndex,
      double[] result);
  ...
  /**
   * Compares the provided quaternions componentwise and returns true if they are
  ...
  /**
   * Computes the spherical linear interpolation or extrapolation at t using the
   * provided quaternions. This implementation is faster than Quaternion#slerp,
   ...
   */
  @JsMethod
  public static native Quaternion fastSquad(Quaternion q0, Quaternion q1, Quaternion s0, Quaternion s1, float t,
      Quaternion result);
  ...
  /**
   * Computes a rotation from the given heading, pitch and roll angles. Heading is
   * the rotation about the negative z axis. Pitch is the rotation about the
   * negative y axis. Roll is the rotation about the positive x axis.
   * 
   ...
   * @param result The object onto which to store the result.
   * @return The modified result parameter.
   * @see #fastSlerp(org.cesiumjs.cs.core.Quaternion,
   *      org.cesiumjs.cs.core.Quaternion, double,
   *      org.cesiumjs.cs.core.Quaternion)
   */
  @JsMethod
   ...
   * @param result The object onto which to store the result.
   * @return The modified result parameter.
   * @see Quaternion#computeInnerQuadrangle(org.cesiumjs.cs.core.Quaternion,
   *      org.cesiumjs.cs.core.Quaternion, org.cesiumjs.cs.core.Quaternion,
   *      org.cesiumjs.cs.core.Quaternion)
   */
  @JsMethod
  public static native Quaternion squad(Quaternion q0, Quaternion q1, Quaternion s0, Quaternion s1, float t,
      Quaternion result);
   ...
   * @param lastIndex     The lastIndex used to convert the array. Default:
   *                      packedArray.length
   * @return The modified result parameter or a new Quaternion instance if one was
   *         not provided.
   */
  public static native Quaternion unpackInterpolationResult(double[] array, double[] sourceArray, int startingIndex,
      int lastIndex);
   ...
   */
  public static native Quaternion unpackInterpolationResult(double[] array, double[] sourceArray, int startingIndex,
      int lastIndex, Quaternion result);
  ...
  /**
   * Compares this and the provided quaternion componentwise and returns true if
