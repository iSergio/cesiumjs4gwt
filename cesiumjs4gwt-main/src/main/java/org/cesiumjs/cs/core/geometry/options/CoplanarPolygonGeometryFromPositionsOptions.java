...
/**
 * Options for {@link org.cesiumjs.cs.core.geometry.CoplanarPolygonGeometry#fromPositions(CoplanarPolygonGeometryFromPositionsOptions)}
 *
...
public class CoplanarPolygonGeometryFromPositionsOptions {
     ...
     * @param positions An array of positions that defined the corner points of the polygon.
