...
public class Cartesian3 implements Packable {
     ...
     * not provided. (Returns undefined if cartesian is undefined)
     */
    @JsMethod
    ...
    /**
     * Compares the provided Cartesians componentwise and returns true if they are
    ...
    /**
     * Compares the provided Cartesians componentwise and returns true if they pass
     * an absolute or relative tolerance test, false otherwise.
     *
     * @param left            The first Cartesian. Optional.
     * @param right           The second Cartesian. Optional.
     ...
     */
    @JsMethod
    public static native boolean equalsEpsilon(Cartesian3 left, Cartesian3 right, double relativeEpsilon,
     ...
     * </pre>
     *
     * @param array  The array whose two consecutive elements correspond to the x
    ...
    /**
     * Creates a Cartesian3 instance from an existing Cartesian4. This simply takes
     * the x and y properties of the Cartesian4 and drops z and w.
     *
     * @param cartesian The Cartesian4 instance to create a Cartesian3 instance
     *                  from.
     * @param result    The object onto which to store the result. Optional.
     * @return The modified result parameter or a new Cartesian3 instance if one was
     * not provided.
    ...
    /**
     * Returns a Cartesian3 position from longitude and latitude values given in
     * degrees.
     *
     * <pre>
     * Example: {
     ...
     * @param height    The height, in meters, above the ellipsoid. Optional.
     *                  Default: 0.0.
     * @param ellipsoid The ellipsoid on which the position lies. Optional. Default:
     *                  Ellipsoid.WGS84.
     * @param result    The object onto which to store the result. Optional.
     * @return The position
     */
    @JsMethod
    public static native Cartesian3 fromDegrees(double longitude, double latitude, double height, Ellipsoid ellipsoid,
                                                Cartesian3 result);

    /**
     * Returns an array of Cartesian3 positions given an array of longitude and
     * latitude values given in degrees.
     *
     * <pre>
     * Example: {
     *   &#64;code
     ...
     * </pre>
     *
     * @param coordinates A list of longitude and latitude values. Values alternate
    ...
    /**
     * Returns an array of Cartesian3 positions given an array of longitude,
     * latitude and height values where longitude and latitude are given in degrees.
     *
     * <pre>
     * Example: {
     *   &#64;code
     ...
     * </pre>
     *
     * @param coordinates A list of longitude, latitude and height values. Values
     *                    alternate [longitude, latitude, height, longitude,
     *                    latitude, height...].
     * @return The array of positions.
     */
    @JsMethod
     ...
     *                    alternate [longitude, latitude, height, longitude,
     *                    latitude, height...].
     * @param ellipsoid   The ellipsoid on which the position lies. Optional.
     ...
     */
    @JsMethod
    public static native Cartesian3[] fromDegreesArrayHeights(double[] coordinates, Ellipsoid ellipsoid,
                                                              Cartesian3[] result);
     ...
     * @param latitude  The latitude, in radians
     * @param height    The height, in meters, above the ellipsoid. Optional.
     * @param ellipsoid The ellipsoid on which the position lines. Optional.
     *                  Default: Ellipsoid.WGS84.
     * @param result    The object onto which to store the result. Optional.
     * @return The position.
     */
    @JsMethod
    public static native Cartesian3 fromRadians(double longitude, double latitude, double height, Ellipsoid ellipsoid,
                                                Cartesian3 result);
    ...
    /**
     * Returns an array of Cartesian3 positions given an array of longitude,
     * latitude and height values where longitude and latitude are given in radians.
     *
     * <pre>
     * {
     *   &#64;code
     ...
     */
    @JsMethod
    public static native Cartesian3[] fromRadiansArrayHeights(double[] coordinates, Ellipsoid ellipsoid,
                                                              Cartesian3[] result);
    ...
    /**
     * Computes the linear interpolation or extrapolation at t using the provided
     * cartesians.
     *
     ...
     *
     * @param cartesian The Cartesian instance whose squared magnitude is to be
     *                  computed.
    ...
    /**
     * Compares two Cartesians and computes a Cartesian which contains the maximum
     * components of the supplied Cartesians.
     *
    ...
    /**
     * Compares two Cartesians and computes a Cartesian which contains the minimum
     * components of the supplied Cartesians.
     *
     * @param first  A cartesian to compare.
     * @param second A cartesian to compare.
    ...
    /**
     * Compares this Cartesian against the provided Cartesian componentwise and
    ...
    /**
     * Compares this Cartesian against the provided Cartesian componentwise and
     * returns true if they pass an absolute or relative tolerance test, false
     * otherwise.
     *
     * @param right           The right hand side Cartesian. Optional.
     * @param relativeEpsilon The relative epsilon tolerance to use for equality
