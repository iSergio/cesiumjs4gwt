...
public class Cartographic {
   ...
   * @return The modified result parameter or a new Cartographic instance if one
   *         was not provided. (Returns undefined if cartographic is undefined)
   */
  @JsMethod
  public static native Cartographic clone(Cartographic cartographic, Cartographic result);

  /**
   * Compares the provided cartographics componentwise and returns true if they
  ...
  /**
   * Compares the provided cartographics componentwise and returns true if they
   * are within the provided epsilon, false otherwise.
   * 
   * @param left    The first cartographic. Optional.
   * @param right   The second cartographic. Optional.
  ...
  /**
   * Creates a new Cartographic instance from a Cartesian position. The values in
   * the resulting object will be in radians.
   * 
  ...
  /**
   * Creates a new Cartographic instance from longitude and latitude specified in
   * degrees. The values in the resulting object will be in radians.
   * 
   ...
   */
  @JsMethod
  public static native Cartesian3 toCartesian(Cartographic cartographic, Ellipsoid ellipsoid, Cartesian3 result);
  ...
  /**
   * Creates a string representing this cartographic in the format '(longitude,
   * latitude, height)'.
   * 
   * @return A string representing the provided cartographic in the format
