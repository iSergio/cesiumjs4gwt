...
public class BoundingRectangle {
  ...
  /**
   * The height of the rectangle. Default: 0.0
   */
  @JsProperty
  public double height;

  /**
   * The width of the rectangle. Defult: 0.0
   */
  @JsProperty
  double width;
  /**
   * The x coordinate of the rectangle. Default: 0.0
   */
  @JsProperty
  double x;
  /**
   * The y coordinate of the rectangle. Default: 0.0
   */
  @JsProperty
  double y;
   ...
   * @return The modified result parameter or a new BoundingRectangle instance if
   *         one was not provided. (Returns undefined if rectangle is undefined)
   */
  @JsMethod
  ...
  /**
   * Compares the provided BoundingRectangles componentwise and returns true if
  ...
  /**
   * Computes a bounding rectangle by enlarging the provided rectangle until it
  ...
  /**
   * Computes a bounding rectangle enclosing the list of 2D points. The rectangle
   * is oriented with the corner at the bottom left.
   * 
   * @param positions List of points that the bounding rectangle will enclose.
   ...
   * @return {@link Intersect#INTERSECTING()} if the rectangles intersect,
   *         {@link Intersect#OUTSIDE()} otherwise.
   */
  @JsMethod
  ...
  /**
   * Compares this BoundingRectangle against the provided BoundingRectangle
