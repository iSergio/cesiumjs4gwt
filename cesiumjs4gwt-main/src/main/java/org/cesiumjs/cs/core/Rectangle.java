...
public class Rectangle {
    ...
    /**
     * The easternmost longitude in radians in the range [-Pi, Pi]. Default: 0.0
     */
    @JsProperty
    public double east;
    /**
    ...
    /**
     * The northernmost latitude in radians in the range [-Pi/2, Pi/2]. Default: 0.0
     */
    @JsProperty
    public double north;
    /**
     * The southernmost latitude in radians in the range [-Pi/2, Pi/2]. Default: 0.0
     */
    @JsProperty
    public double south;
    /**
     * The westernmost longitude in radians in the range [-Pi, Pi]. Default: 0.0
     */
    @JsProperty
    public double west;
    /**
     ...
     * @return The modified result parameter or a new Cartographic instance if none
     * was provided.
     */
    @JsMethod
     ...
     * @return The modified result parameter or a new Rectangle instance if none was
     * provided. (Returns undefined if rectangle is undefined)
     */
    @JsMethod
    ...
    /**
     * Returns true if the cartographic is on or inside the rectangle, false
     * otherwise.
     *
     * @param rectangle    The rectangle
     * @param cartographic The cartographic to test.
     * @return true if the provided cartographic is inside the rectangle, false
     * otherwise.
     */
    @JsMethod
    ...
    /**
     * Compares the provided rectangles and returns true if they are equal, false
     * otherwise.
     *
    ...
    /**
     * Compares the provided Rectangles componentwise and returns true if they pass
    ...
    /**
     * Computes a rectangle by enlarging the provided rectangle until it contains
     * the provided cartographic.
     *
     * @param rectangle    A rectangle to expand.
     * @param cartographic A cartographic to enclose in a rectangle.
     * @return The modified result parameter or a new Rectangle instance if one was
     * not provided.
     */
    @JsMethod
    ...
    /**
     * Creates the smallest possible Rectangle that encloses all positions in the
     * provided array.
     *
     ...
     *
     * @param cartesians The list of Cartesian instances.
     * @param ellipsoid  The ellipsoid the cartesians are on. Default:
     ...
     * @param ellipsoid  The ellipsoid the cartesians are on. Default:
     *                   {@link Ellipsoid#WGS84}.
     * @param result     The object onto which to store the result, or undefined if
     ...
     *
     * @param cartographics The list of Cartographic instances.
     * @param result        The object onto which to store the result, or undefined
     *                      if a new instance should be created.
     * @return The modified result parameter or a new Rectangle instance if none was
     * provided.
     */
    @JsMethod
     ...
     * </pre>
     *
     * @param west  The westernmost longitude in degrees in the range [-180.0,
     *              180.0].
     * @param south The southernmost latitude in degrees in the range [-90.0, 90.0].
     * @param east  The easternmost longitude in degrees in the range [-180.0,
     *              180.0].
     ...
     * @param west   The westernmost longitude in degrees in the range [-180.0,
     *               180.0].
     * @param south  The southernmost latitude in degrees in the range [-90.0,
     *               90.0].
     * @param east   The easternmost longitude in degrees in the range [-180.0,
     *               180.0].
     * @param north  The northernmost latitude in degrees in the range [-90.0,
     *               90.0].
     * @param result The object onto which to store the result, or undefined if a
     *               new instance should be created.
     * @return The modified result parameter or a new Rectangle instance if none was
     ...
     *
     * @param west  The westernmost longitude in radians in the range [-Math.PI,
     *              Math.PI]. Default: 0.0.
     * @param south The southernmost latitude in radians in the range [-Math.PI/2,
     *              Math.PI/2]. Default: 0.0.
     * @param east  The easternmost longitude in radians in the range [-Math.PI,
     *              Math.PI]. Default: 0.0.
     * @param north The northernmost latitude in radians in the range [-Math.PI/2,
     *              Math.PI/2]. Default: 0.0.
     * @return The modified result parameter or a new Rectangle instance if none was
     * provided.
     */
     ...
     * @return The modified result parameter, a new Rectangle instance if none was
     * provided or undefined if there is no intersection.
     */
    @JsMethod
    ...
    /**
     * Samples an rectangle so that it includes a list of Cartesian points suitable
     * for passing to BoundingSphere#fromPoints. Sampling is necessary to account
     * for rectangles that cover the poles or cross the equator.
     *
     * @param rectangle The rectangle to subsample.
     * @return The modified result parameter or a new Array of Cartesians instances
     ...
     * @return true if the Rectangles are within the provided epsilon, false
     * otherwise.
     */
    @JsMethod
