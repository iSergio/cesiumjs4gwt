...
public class GeometryInstanceAttribute {
   ...
   * {@link GeometryInstanceAttribute#value}. Default: undefined
   */
  @JsProperty
   ...
   * would have 3 as shown in the code example. Default: undefined
   */
  @JsProperty
   ...
   * commonly used when storing colors using
   * {@link ComponentDatatype#UNSIGNED_BYTE()}. Default: false
   */
  @JsProperty
   ...
   * componentsPerAttribute is 3. Default: undefined
   */
  @JsProperty
  public double[] value;
