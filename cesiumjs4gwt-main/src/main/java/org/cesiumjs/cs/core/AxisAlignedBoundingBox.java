...
public class AxisAlignedBoundingBox {
  ...
  /**
   * The maximum point defining the bounding box. Default:
   * {@link Cartesian3#ZERO()}
   */
  @JsProperty
  public Cartesian3 maximum;
  /**
   * The minimum point defining the bounding box. Default:
   * {@link Cartesian3#ZERO()}
   */
  @JsProperty
  ...
  /**
   * Creates an instance of an AxisAlignedBoundingBox from the minimum and maximum
   ...
   * @return The modified result parameter or a new AxisAlignedBoundingBox
   *         instance if none was provided. (Returns undefined if box is
   *         undefined)
   */
  @JsMethod
  ...
  /**
   * Compares the provided AxisAlignedBoundingBox componentwise and returns true
   ...
   * 
   * @param positions List of points that the bounding box will enclose. Each
   *                  point must have a x, y, and z properties.
   * @param result    The object onto which to store the result.
   ...
   * @return {@link org.cesiumjs.cs.core.enums.Intersect#INSIDE()} if the entire
   *         box is on the side of the plane the normal is pointing,
   *         {@link Intersect#OUTSIDE()} if the entire box is on the opposite
   *         side, and {@link Intersect#INTERSECTING()} if the box intersects the
   *         plane.
   */
  @JsMethod
