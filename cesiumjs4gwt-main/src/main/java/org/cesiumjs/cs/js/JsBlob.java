...
//            Blob.stream()
//    Transforms the Blob into a ReadableStream that can be used to read the Blob contents.

    /**
     * Transforms the Blob into a stream and reads it to completion. It returns a promise that resolves with a USVString (text).
     * @return text string
     */
    @JsMethod
    public native String text();
    /**
     * Transforms the Blob into a stream and reads it to completion. It returns a promise that resolves with an ArrayBuffer.
     * @return ArrayBuffer
     */
    @JsMethod
