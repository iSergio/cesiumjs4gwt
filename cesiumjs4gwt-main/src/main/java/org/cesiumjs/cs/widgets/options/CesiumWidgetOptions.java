...
public class CesiumWidgetOptions {
  ...
  public Clock clock;
  /**
   * The imagery provider to serve as the base layer. If set to false, no imagery
   * provider will be added. Default: new BingMapsImageryProvider()
   */
  @JsProperty
  public ImageryProvider imageryProvider;
  /**
   * The terrain provider. Defaults: new EllipsoidTerrainProvider
   */
  @JsProperty
  public TerrainProvider terrainProvider;
  /**
   * The skybox used to render the stars. When undefined, the default stars are
   * used. If set to false, no skyBox, Sun, or Moon will be added.
   */
  @JsProperty
  ...
  /**
   * The initial scene mode. Default: SceneMode.SCENE3D
   */
  @JsProperty
   ...
   * horizontal direction. Default: MapMode2D.INFINITE_SCROLL
   */
  @JsProperty
