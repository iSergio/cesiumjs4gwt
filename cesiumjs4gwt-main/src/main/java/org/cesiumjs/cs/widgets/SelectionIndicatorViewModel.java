...
public class SelectionIndicatorViewModel {
  /**
   * Gets or sets the function for converting the world position of the object to
   * the screen space position. Default: SceneTransforms.wgs84ToWindowCoordinates
   */
  @JsProperty
  ...
  /**
   * Gets or sets the world position of the object for which to display the
   * selection indicator.
   */
  @JsProperty
   ...
   * The view model for {@link SelectionIndicator}.
   * 
   * @param scene                     The scene instance to use for screen-space
   *                                  coordinate conversion.
   * @param selectionIndicatorElement The element containing all elements that
   *                                  make up the selection indicator.
  ...
  /**
   * Updates the view of the selection indicator to match the position and content
   * properties of the view model. This function should be called as part of the
   * render loop.
   */
  @JsMethod
  ...
  /**
   * A function that converts the world position of an object to a screen space
   * position.
   */
  @JsFunction
  interface ComputeScreenSpacePosition {
     ...
     * @param result   An object to return the input position transformed to window
     *                 coordinates.
