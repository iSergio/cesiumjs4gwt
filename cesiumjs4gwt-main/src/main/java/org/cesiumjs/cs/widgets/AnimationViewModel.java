...
public class AnimationViewModel {
  ...
  /**
   * Gets or sets the default array of known clock multipliers associated with new
  ...
  /**
   * Gets or sets the function which formats a date for display. Default:
   * {@link #defaultDateFormatter}
   */
  @JsProperty
  public DateFormatter dateFormatter;
  /**
   * Gets the string representation of the current date. This property is
   * observable.
   */
  @JsProperty
  ...
  /**
   * Gets the string representation of the current multiplier. This property is
   * observable.
   */
  @JsProperty
  ...
  /**
   * Gets or sets whether the shuttle ring is currently being dragged. This
   * property is observable. Default: false
   */
  @JsProperty
  ...
  /**
   * Gets or sets whether dragging the shuttle ring should cause the multiplier to
   * snap to the defined tick values rather than interpolating between them. This
   * property is observable. Default: false
   */
  @JsProperty
  public boolean snapToTicks;
  /**
   * Gets or sets the function which formats a time for display. Default:
   * {@link #defaultTimeFormatter}
   */
  public TimeFormatter timeFormatter;
  /**
   * Gets the string representation of the current time. This property is
   * observable.
   */
  @JsProperty
  ...
  /**
   * Gets a copy of the array of positive known clock multipliers to associate
   * with the shuttle ring.
   * 
   * @return The array of known clock multipliers associated with the shuttle
   *         ring.
   */
  @JsMethod
  ...
  /**
   * Sets the array of positive known clock multipliers to associate with the
   * shuttle ring. These values will have negative equivalents created for them
   * and sets both the minimum and maximum range of values for the shuttle ring as
   * well as the values that are snapped to when a single click is made. The
   * values need not be in order, as they will be sorted automatically, and
   * duplicate values will be removed.
   * 
   * @param positiveTicks The list of known positive clock multipliers to
