...
public class GeocoderViewModelOptions {
    ...
    public Scene scene;
    /**
     * Geocoder services to use for geocoding queries. If more than one are supplied, suggestions will be gathered for
     * the geocoders that support it, and if no suggestion is selected the result from the first geocoder
     * service wil be used.
     */
    @JsProperty
