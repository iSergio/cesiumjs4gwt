...
/**
 * The SceneModePicker is a single button widget for switching between scene
 * modes; shown to the left in its expanded state. Programatic switching of
 * scene modes will be automatically reflected in the widget as long as the
 * specified Scene is used to perform the change.
 *
