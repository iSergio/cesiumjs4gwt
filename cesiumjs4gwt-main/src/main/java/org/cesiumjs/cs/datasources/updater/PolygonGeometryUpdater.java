...
/**
 * A {@link GeometryUpdater} for polygons. Clients do not normally create this class directly,
 * but instead rely on {@link org.cesiumjs.cs.datasources.DataSourceDisplay}.
 * @author Serge Silaev aka iSergio <s.serge.b@gmail.com>
 */
@JsType(isNative = true, namespace = "Cesium", name = "PolygonGeometryUpdater")
public class PolygonGeometryUpdater extends GeometryUpdater {
    /**
     ...
     */
    @JsConstructor
    public PolygonGeometryUpdater(Entity entity, Scene scene) {
        super(entity, scene);
    }
}
