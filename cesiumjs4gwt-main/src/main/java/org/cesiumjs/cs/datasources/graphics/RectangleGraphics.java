...
public class RectangleGraphics {
  ...
  /**
   * Gets or sets the boolean Property specifying whether the rectangle has a
   * bottom cover when extruded. Default: true
   */
  @JsProperty
  public Property closeBottom;
  /**
   * Gets or sets the boolean Property specifying whether the rectangle has a top
   * cover when extruded. Default: true
   */
  @JsProperty
   ...
   * distance from the camera that this rectangle will be displayed.
   */
  @JsProperty
   ...
   * extrusion. Setting this property creates volume starting at height and ending
   * at this altitude.
   */
  @JsProperty
  ...
  /**
   * Gets or sets the boolean Property specifying whether the rectangle is filled
   * with the provided material. Default: true
   */
  @JsProperty
  public Property fill;

  /**
   * Gets or sets the numeric Property specifying the angular distance between
   * points on the rectangle. Default: {@link Math#RADIANS_PER_DEGREE()}
   */
  @JsProperty
  ...
  /**
   * Gets or sets the numeric property specifying the rotation of the rectangle
   * clockwise from north. Default: 0
   */
  @JsProperty
  public Property rotation;
  /**
   * Get or sets the enum Property specifying whether the rectangle casts or
   * receives shadows from each light source. Default:
   * {@link ShadowMode#DISABLED()}
   */
  @JsProperty
  public int shadows;
  /**
  ...
  /**
   * Gets or sets the numeric property specifying the rotation of the rectangle
   * texture counter-clockwise from north. Default: 0
   */
  @JsProperty
  public Property stRotation;
  /**
   * A Property specifying the zIndex used for ordering ground geometry. Only has
   * an effect if the rectangle is constant and neither height or extrudedHeight
   * are specified. Default: 0
   */
  @JsProperty
  public ConstantProperty<Integer> zIndex;

  /**
   * Describes graphics for a {@link org.cesiumjs.cs.core.Rectangle}. The
   * rectangle conforms to the curvature of the globe and can be placed on the
   * surface or at altitude and can optionally be extruded into a volume.
   */
  @JsConstructor
