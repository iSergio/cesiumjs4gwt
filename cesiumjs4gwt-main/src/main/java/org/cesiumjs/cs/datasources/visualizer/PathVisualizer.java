 ...
 */
@JsType(isNative = true, namespace = "Cesium", name = "PathVisualizer")
public class PathVisualizer implements Visualizer {
  /**
   * A {@link Visualizer} which maps
   * {@link org.cesiumjs.cs.datasources.Entity#path} to a Polyline.
   * 
   ...
   */
  @JsConstructor
  public PathVisualizer(EntityCluster entityCluster, EntityCollection entityCollection) {
  }
