...
public class SampledPositionProperty extends PositionProperty {
    ...
    /**
     * The number of derivatives contained by this property; i.e. 0 for just
     * position, 1 for velocity, etc. Default: false
     */
    @JsProperty
     ...
     * A {@link SampledProperty} which is also a {@link PositionProperty}.
     *
     * @param referenceFrame      The reference frame in which the position is
     *                            defined.
     * @param numberOfDerivatives The number of derivatives that accompany each
     *                            position; i.e. velocity, acceleration, etc...
     */
    @JsConstructor
     ...
     *
     * @param times     An array of JulianDate instances where each index is a
     *                  sample time.
     * @param positions The array of values, where each value corresponds to the
     ...
     *                         a sample time.
     * @param positions        The array of values, where each value corresponds to
