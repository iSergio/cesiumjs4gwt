 ...
 * defined as part of a {@link Entity} into
 * {@link org.cesiumjs.cs.core.geometry.Geometry} instances. These instances are
 * then visualized by GeometryVisualizer. This type defines an interface and
...
public abstract class GeometryUpdater {
   ...
   * distance from the camera that this geometry will be displayed.
   */
  ...
  /**
   * Gets an event that is raised whenever the public properties of this updater
   * change.
   */
  ...
  /**
   * Gets a value indicating if the geometry is closed. This property is only
   * valid for static geometry.
   */
  @JsProperty(name = "isClosed")
  public native boolean isClosed();

  /**
   * Gets a value indicating if the geometry is time-varying. If true, all
   * visualization is delegated to the DynamicGeometryUpdater returned by
   * GeometryUpdater#createDynamicUpdater.
   */
  ...
  /**
   * Gets the constant with of the geometry outline, in pixels. This value is only
   * valid if isDynamic is false.
   */
  ...
  /**
   * Creates the dynamic updater to be used when {@link GeometryUpdater#isDynamic}
   * is true.
   * 
   ...
   * @return The geometry instance representing the filled portion of the
   *         geometry.
   */
  @JsMethod
   ...
   * 
   * @param time The time to use when retrieving initial attribute values.
   * @return The geometry instance representing the outline portion of the
   *         geometry.
   */
  @JsMethod
