...
public class CzmlDataSource implements DataSource {
  ...
  // staticCesium.CzmlDataSource.updaters : Array DataSources/CzmlDataSource.js
  // 1965
  ...
  /**
   * A {@link DataSource} which processes <a hreh=
   * "https://github.com/AnalyticalGraphicsInc/cesium/wiki/CZML-Guide">CZML</a>.
   */
  @JsConstructor
   ...
   * "https://github.com/AnalyticalGraphicsInc/cesium/wiki/CZML-Guide">CZML</a>.
   * 
   * @param name An optional name for the data source. This value will be
   ...
   * @return A promise that resolves to the new instance once the data is
   *         processed.
   */
  @JsMethod
  ...
  // Name Type Description
  // sourceUri String optional Overrides the url to use for resolving relative
  // links.
  // Returns:
  // A promise that resolves to the new instance once the data is processed.
  //
  //
  // staticCesium.CzmlDataSource.processMaterialPacketData(object, propertyName,
  // packetData, interval, sourceUri, entityCollection)
  // DataSources/CzmlDataSource.js 2052
  // A helper function used by custom CZML updater functions which creates or
  // updates a MaterialProperty from a CZML packet.
  // Name Type Description
  ...
  // staticCesium.CzmlDataSource.processPacketData(type, object, propertyName,
  // packetData, interval, sourceUri, entityCollection)
  // DataSources/CzmlDataSource.js 2024
  // A helper function used by custom CZML updater functions which creates or
  // updates a Property from a CZML packet.
  // Name Type Description
  ...
  // sourceUri String The originating uri of the data being processed.
  // entityCollection EntityCollection The collection being processsed.
  // staticCesium.CzmlDataSource.processPositionPacketData(object, propertyName,
  // packetData, interval, sourceUri, entityCollection)
  // DataSources/CzmlDataSource.js 2038
  // A helper function used by custom CZML updater functions which creates or
  // updates a PositionProperty from a CZML packet.
  // Name Type Description
  // object Object The object on which the property will be added or updated.
  // propertyName String The name of the property on the object.
  // packetData Object The CZML packet being processed.
  ...
  // sourceUri String The originating uri of the data being processed.
  // entityCollection EntityCollection The collection being processsed.
  // load(czml, options) → Promise.<CzmlDataSource> DataSources/CzmlDataSource.js
  // 2007
