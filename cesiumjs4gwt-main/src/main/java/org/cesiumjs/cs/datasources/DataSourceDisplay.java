...
public class DataSourceDisplay implements DataSource {
  /**
   * Gets or sets the default function which creates an array of visualizers used
   * for visualization. By default, this function uses all standard visualizers.
   */
  ...
  /**
   * Gets the default data source instance which can be used to manually create
   * and visualize entities not tied to a specific data source. This instance is
   * always available and does not appear in the list dataSources collection.
   */
  @JsProperty
  public CustomDataSource defaultDataSource;

  /**
   * Gets a value indicating whether or not all entities in the data source are
   * ready
   */
