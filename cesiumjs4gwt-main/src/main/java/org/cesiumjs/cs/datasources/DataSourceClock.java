...
public class DataSourceClock {
   ...
   * {@link org.cesiumjs.cs.core.Clock#multiplier}.
   */
  @JsProperty
  public int multiplier;
  /**
   * Gets or sets the desired start time of the clock. See
   * {@link org.cesiumjs.cs.core.Clock#startTime}.
   */
  @JsProperty
  public JulianDate startTime;
  /**
   * Gets or sets the desired stop time of the clock. See
   * {@link org.cesiumjs.cs.core.Clock#stopTime}.
   */
  @JsProperty
  public JulianDate stopTime;

  /**
   * Represents desired clock settings for a particular DataSource. These settings
   * may be applied to the Clock when the {@link DataSource} is loaded.
   */
  @JsConstructor
