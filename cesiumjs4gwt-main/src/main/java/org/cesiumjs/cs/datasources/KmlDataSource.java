...
public class KmlDataSource implements DataSource {
    ...
    /**
     * Gets a human-readable name for this instance. This will be automatically be
     * set to the KML document name on load.
     */
    @JsProperty
    public String name;
    /**
     * Gets an event that will be raised when the data source refreshes a network
     * link.
     */
    @JsProperty
    ...
    public boolean show;
    /**
     * Gets an event that will be raised when the data source finds an unsupported
     * node type.
     */
    @JsProperty
    ...
    /**
     * A DataSource which processes Keyhole Markup Language 2.2 (KML). KML support
     * in Cesium is incomplete, but a large amount of the standard, as well as
     * Google's gx extension namespace, is supported. See Github issue #873 for a
     * detailed list of what is and isn't support. Cesium will also write
     * information to the console when it encounters most unsupported features.
     * <p>
     * Non visual feature data, such as atom:author and ExtendedData is exposed via
     * an instance of KmlFeatureData, which is added to each Entity under the kml
     * property.
     *
     * @param options Options
     * @see <a href="http://www.opengeospatial.org/standards/kml/">Open Geospatial
     * Consortium KML Standard</a>
     * @see <a href="https://developers.google.com/kml//">Google KML
     * Documentation</a>
     */
    @JsConstructor
     ...
     * @return A promise that will resolve to a new KmlDataSource instance once the
     * KML is loaded.
     */
    @JsMethod
