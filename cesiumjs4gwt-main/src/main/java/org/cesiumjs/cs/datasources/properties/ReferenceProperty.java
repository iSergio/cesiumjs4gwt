...
public class ReferenceProperty extends Property {
  ...
  /**
   * Gets the reference frame that the position is defined in. This property is
   * only valid if the referenced property is a PositionProperty.
   */
   ...
   * object.
   * 
   * @param targetCollection    The entity collection which will be used to
   *                            resolve the reference.
   * @param targetId            The id of the entity which is being referenced.
   * @param targetPropertyNames The names of the property on the target entity
   *                            which we will use.
   */
  @JsConstructor
  ...
  /**
   * Creates a new instance given the entity collection that will be used to
   * resolve it and a string indicating the target entity id and property. The
   * format of the string is "objectId#foo.bar", where # separates the id from
  ...
  /**
   * Gets the Material type at the provided time. This method is only valid if the
   * property being referenced is a MaterialProperty.
   * 
  ...
  /**
   * Gets the value of the property at the provided time and in the provided
   * reference frame. This method is only valid if the property being referenced
   * is a PositionProperty.
   * 
   * @param time           The time for which to retrieve the value.
   * @param referenceFrame {@link ReferenceFrame} The desired referenceFrame of
   *                       the result.
   * @return The modified result parameter or a new instance if the result
   *         parameter was not supplied.
   */
   ...
   * @param referenceFrame {@link ReferenceFrame} The desired referenceFrame of
   *                       the result.
   * @param result         The object to store the value into, if omitted, a new
