 ...
 * but PrimitiveCollection is also a primitive itself so collections can be added to collections 
 * forming a hierarchy.
...
public class PrimitiveCollection extends Collection<Object> {
   ...
   * removed by {@link PrimitiveCollection#destroy()} or
   * {@link PrimitiveCollection#remove(Object)} or implicitly by
   * PrimitiveCollection#removeAll. Default: true
   */
  @JsProperty
  public boolean destroyPrimitives;
  /**
   * Determines if primitives in this collection will be shown. Default: true
   */
  @JsProperty
  public boolean show;
   ...
   * {@link Scene#primitives()}, but PrimitiveCollection is also a primitive
   * itself so collections can be added to collections forming a hierarchy.
   */
  @JsConstructor
  ...
  /**
   * Lowers a primitive "down one" in the collection. If all primitives in the
   * collection are drawn on the globe surface, this visually moves the primitive
   * down one.
   * 
  ...
  /**
   * Lowers a primitive to the "bottom" of the collection. If all primitives in
   * the collection are drawn on the globe surface, this visually moves the
   * primitive to the bottom.
   * 
  ...
  /**
   * Raises a primitive "up one" in the collection. If all primitives in the
   * collection are drawn on the globe surface, this visually moves the primitive
   * up one.
   * 
  ...
  /**
   * Raises a primitive to the "top" of the collection. If all primitives in the
   * collection are drawn on the globe surface, this visually moves the primitive
   * to the top.
   * 
