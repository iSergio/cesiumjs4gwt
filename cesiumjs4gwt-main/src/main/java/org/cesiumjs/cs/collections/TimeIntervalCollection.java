...
public class TimeIntervalCollection {
  ...
  /**
   * A non-overlapping collection of {@link TimeInterval} instances sorted by
   * start time.
   */
  @JsConstructor
  ...
  @SuppressWarnings("rawtypes")
  @JsMethod
  public static native TimeIntervalCollection 
  ...
  @JsMethod
  public static native TimeIntervalCollection 
      fromIso8601DateArray(FromIso8601DateArrayOptions options, TimeIntervalCollection result);
   ...
   */
  @JsMethod
  public static native TimeIntervalCollection fromIso8601DurationArray(
      FromIso8601DurationArrayOptions options,
      TimeIntervalCollection result);
   ...
   */
  @JsMethod
  public static native TimeIntervalCollection fromJulianDateArray(
      FromJulianDateArrayOptions options,
      TimeIntervalCollection result);

  /**
   * Adds an interval to the collection, merging intervals that contain the same
   * data and splitting intervals of different data as needed in order to maintain
   * a non-overlapping collection. The data in the new interval takes precedence
   * over any existing intervals in the collection.
   * 
   ...
   * 
   * @param interval     The interval to add.
   * @param dataComparer A function which compares the data of the two intervals.
  ...
  /**
   * Compares this instance against the provided instance componentwise and
   ...
   * @return The data for the interval containing the specified date, or undefined
  ...
  /**
   * Returns the first interval in the collection that matches the specified
   * parameters. All parameters are optional and undefined parameters are treated
   * as a don't care condition.
   * 
   * @return The first interval in the collection that matches the specified
   *         parameters.
   */
  @JsMethod
   ...
   * 
   * @param date The date to search for.
   * @return The interval containing the specified date, undefined if no such
   *         interval exists.
   */
  @JsMethod
  ...
  /**
   * Finds and returns the index of the interval in the collection that contains
   * the specified date.
   * 
   * @param date The date to search for.
   * @return The index of the interval that contains the specified date, if no
   *         such interval exists, it returns a negative number which is the
   *         bitwise complement of the index of the next interval that starts
   *         after the date, or if no interval starts after the specified date,
   *         the bitwise complement of the length of the collection.
   */
  @JsMethod
  public native int indexOf(JulianDate date);

  /**
   * Creates a new instance that is the intersection of this collection and the
   * provided collection.
   * 
   * @param other The collection to intersect with.
   * @return A new TimeIntervalCollection which is the intersection of this
   ...
   * @param dataComparer  A function which compares the data of the two intervals.
   *                      If omitted, reference equality is used.
   * @param mergeCallback A function which merges the data of the two intervals.
   *                      If omitted, the data from the left interval will be
   *                      used.
   * @return A new TimeIntervalCollection which is the intersection of this
   *         collection and the provided collection.
   */
  ...
  /**
   * Removes the specified interval from this interval collection, creating a hole
   * over the specified interval. The data property of the input interval is
   * ignored.
   * 
   * @param interval true if the interval was removed, false if no part of the
   *                 interval was in the collection.
   */
  @JsMethod
