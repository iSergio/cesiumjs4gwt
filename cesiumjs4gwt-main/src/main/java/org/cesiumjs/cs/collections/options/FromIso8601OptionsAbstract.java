...
public abstract class FromIso8601OptionsAbstract<T> {
  /**
   * if start time is included in the interval, false otherwise. Default: true
   */
  @JsProperty
  public boolean isStartIncluded;
  /**
   * if stop time is included in the interval, false otherwise. Default: true
   */
  @JsProperty
  ...
  /**
   * A function that will be return the data that is called with each interval
   * before it is added to the collection. If unspecified, the data will be the
