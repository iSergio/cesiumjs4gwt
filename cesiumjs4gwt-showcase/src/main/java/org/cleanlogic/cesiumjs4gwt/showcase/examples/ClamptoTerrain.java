...
public class ClamptoTerrain extends AbstractExample {
    ...
    public ClamptoTerrain(ShowcaseExampleStore store) {
        super("Clamp to Terrain", "Clamp primitives to the terrain.", new String[]{"Clamp", "Primitive", "Terrain"}, store);
    }
        ...
        primitiveLBox.addChangeHandler(new ChangeHandler() {
            ...
            public void onChange(ChangeEvent event) {
                ...
                switch (source.getSelectedValue()) {
                    case "0": drawPointWithLabel(); break;
                    case "1": drawBillboard(); break;
                    case "2": drawCorridor(); break;
                    case "3": drawPolygon(); break;
                    case "4": drawTexturedPolygon(); break;
                    case "5": drawRectangle(); break;
                    case "6": drawModel(); break;
                    case "7": drawSampleLine(); break;
    ...
    private void drawPointWithLabel() {
        ...
        labelGraphicsOptions.disableDepthTestDistance = new ConstantProperty<>(Double.POSITIVE_INFINITY); // draws the label in front of terrain
    ...
    private void drawCorridor() {
        ...
        corridorGraphicsOptions.positions = new ConstantProperty<>(Cartesian3.fromDegreesArray(new double [] {
                -122.19, 46.1914,
                -122.21, 46.21,
                -122.23, 46.21
        }));
    ...
    private void drawPolygon() {
        ...
        polygonGraphicsOptions.hierarchy = new ConstantProperty<>(
                new PolygonHierarchy(
                        new Cartesian3[] {
                                new Cartesian3(-2358138.847340281, -3744072.459541374, 4581158.5714175375),
    ...
    private void drawTexturedPolygon() {
        ...
        imageMaterialPropertyOptions.image = new ConstantProperty<>(GWT.getModuleBaseURL() + "images/Cesium_Logo_Color.jpg");
    ...
    private void drawSampleLine() {
        ...
        Cesium.sampleTerrainMostDetailed(csVPanel.getViewer().terrainProvider, terrainSamplePositions).then(new Fulfill<Cartographic[]>() {
            @Override
            public void onFulfilled(Cartographic[] samples) {
                ...
                polylineGraphicsOptions.positions = new ConstantProperty<>(Ellipsoid.WGS84().cartographicArrayToCartesianArray(samples));
                ...
                polylineOutlineMaterialPropertyOptions.outlineWidth = new ConstantProperty<>(2);
                polylineOutlineMaterialPropertyOptions.outlineColor = new ConstantProperty<>(Color.BLACK());
                polylineGraphicsOptions.depthFailMaterial = new PolylineOutlineMaterialProperty(polylineOutlineMaterialPropertyOptions);
                ...
                csVPanel.getViewer().camera.lookAt(target, new Cartesian3(6344.974098678562, -793.3419798081741, 2499.9508860763162));
