...
public class TimeDynamicPointCloud extends AbstractExample {
    ...
    public TimeDynamicPointCloud(ShowcaseExampleStore store) {
        super("Time Dynamic Point Cloud", "Render a time dynamic point cloud from a set of Point Cloud tiles and timestamps", new String[]{"Point cloud", "real time"}, store);
    }
    ...
    public void buildPanel() {
        ...
        TimeDynamicPointCloudOptions timeDynamicPointCloudOptions = TimeDynamicPointCloudOptions.create(csVPanel.getViewer().clock(), timeIntervalCollection);
        timeDynamicPointCloudOptions.style = new Cesium3DTileStyle();
        timeDynamicPointCloudOptions.style.pointSizeDouble = 5.0;
        org.cesiumjs.cs.scene.TimeDynamicPointCloud pointCloud = new org.cesiumjs.cs.scene.TimeDynamicPointCloud(timeDynamicPointCloudOptions);
        ...
        contentPanel.add(new HTML("<p>Render a time dynamic point cloud from a set of Point Cloud tiles and timestamps.</p>"));
