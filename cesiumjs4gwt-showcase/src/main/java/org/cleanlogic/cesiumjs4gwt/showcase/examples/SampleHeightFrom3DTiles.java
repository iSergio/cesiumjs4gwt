...
public class SampleHeightFrom3DTiles extends AbstractExample {
    ...
    public SampleHeightFrom3DTiles(ShowcaseExampleStore store) {
        super("Sample Height from 3D Tiles", "Sample the most detailed heights of a 3D Tileset.", new String[]{"Showcase", "3D", "Tiles", "Height", "Tileset"}, store);
    }
    ...
    public void buildPanel() {
        ...
        cameraViewOptions.orientation = new org.cesiumjs.cs.core.HeadingPitchRoll(4.239925103568368, -0.4911293834802475, 6.279849292088564);
