...
public class PolylinesOn3DTiles extends AbstractExample {
    ...
    public PolylinesOn3DTiles(ShowcaseExampleStore store) {
        super("Polylines on 3D Tiles", "Display polylines on BIM and Photogrammetry 3D Tiles.", new String[]{"BIM", "Photogrammetry", "3D Tiles", "Polylines"}, store);
    }
    ...
    public void buildPanel() {
        ...
        building = (Cesium3DTileset) scene.primitives().add(new Cesium3DTileset(Cesium3DTilesetOptions.create(IonResource.fromAssetId(6074))));
        ...
        tileSetsLBox.addChangeHandler(new ChangeHandler() {
            ...
            public void onChange(ChangeEvent event) {
                ...
                if (source.getSelectedValue().equals("0")) {
                    ...
                    viewOptions.orientation = new org.cesiumjs.cs.core.HeadingPitchRoll(5.593695742186853, -1.0786797635545216, 6.27892466154778);
                    ...
                    viewOptions.orientation = new org.cesiumjs.cs.core.HeadingPitchRoll(5.153176564030707, -0.9701972964526693, 6.277883257569513);
                }
