...
public class GroundPolylinePrimitive extends AbstractExample {
    ...
    public GroundPolylinePrimitive(ShowcaseExampleStore store) {
        super("GroundPolylinePrimitive", "Show how use GroundPolylinePrimitive's", new String[]{"ground", "polyline", "primitive"}, store);
    }
    ...
    public void buildPanel() {
        ...
        Cartesian3[] positions = Cartesian3.fromDegreesArray(
                new double[]{-112.1340164450331, 36.05494287836128,
        ...
        org.cesiumjs.cs.scene.GroundPolylinePrimitive groundPolylinePrimitive = new org.cesiumjs.cs.scene.GroundPolylinePrimitive(primitiveOptions);
        ...
        attributes.setProperty("color", ColorGeometryInstanceAttribute.fromColor(Color.fromCssColorString("green", new Color()).withAlpha(0.7f)));
        attributes.setProperty("distanceDisplayCondition", new DistanceDisplayConditionGeometryInstanceAttribute(1000, 30000));
