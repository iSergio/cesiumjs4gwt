...
public class I3S3DObjectLayer extends AbstractExample {
    @Inject
    public I3S3DObjectLayer(ShowcaseExampleStore store) {
        super("I3S 3D Object Layer",
    ...
    public void buildPanel() {
        ...
        tours.setProperty("San Francisco", "https://tiles.arcgis.com/tiles/z2tnIkrLQ2BRzr6P/arcgis/rest/services/SanFrancisco_3DObjects_1_7/SceneServer/layers/0");
        ...
        I3SDataProviderOptions i3SDataProviderOptions = I3SDataProviderOptions.create(tours.getString("San Francisco"))
        ...
        contentPanel.add(new HTML(
                "<p>Add I3S 3D Object Layer from a service.</p>"));
    ...
    public String[] getSourceCodeURLs() {
        ...
        sourceCodeURLs[0] = GWT.getModuleBaseURL() + "examples/" + "I3S3DObjectLayer.txt";
