 ...
 */
package org.cleanlogic.cesiumjs4gwt.showcase.puregwt;
...
public interface ShowcaseEventBus {
   ...
   * subclass will provide a static <code>register</code> method, or a widget will
   * accept handlers directly.
   * <p>
   ...
   *         handler later
   */
  <T extends EventHandler> HandlerRegistration addHandler(GwtEvent.Type<T> type, T handler);
   ...
   *         handler later
   */
  <T extends EventHandler> HandlerRegistration addHandlerToSource(GwtEvent.Type<T> type, Object source, T handler);
