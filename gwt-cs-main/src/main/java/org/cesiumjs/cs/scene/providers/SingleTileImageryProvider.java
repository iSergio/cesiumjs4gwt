 ...
 */
@JsType(isNative = true, namespace = "Cesium", name = "SingleTileImageryProvider")
public class SingleTileImageryProvider implements ImageryProvider {
    /**
     ...
     * This function should not be called before SingleTileImageryProvider#ready returns true.
     */
...
//    public native Proxy proxy();
    ...
    /**
     * Gets the width of each tile, in pixels. This function should not be called before SingleTileImageryProvider#ready returns true.
     */
    ...
    /**
     * Gets the tiling scheme used by this provider. This function should not be called before SingleTileImageryProvider#ready returns true.
     */
    ...
    /**
     * Provides a single, top-level imagery tile. The single image is assumed to use a {@link org.cesiumjs.cs.core.GeographicTilingScheme}.
     * @param options Options
     */
    @JsConstructor
    public SingleTileImageryProvider(SingleTileImageryProviderOptions options) {}
    ...
    /**
     * Requests the image for a given tile. This function should not be called before SingleTileImageryProvider#ready returns true.
     * @param x The tile X coordinate.
     * @param y The tile Y coordinate.
     * @param level The tile level.
     * @return A promise for the image that will resolve when the image is available, or undefined if there are too
     * many active requests to the server, and the request should be retried later. The resolved image may be either an
