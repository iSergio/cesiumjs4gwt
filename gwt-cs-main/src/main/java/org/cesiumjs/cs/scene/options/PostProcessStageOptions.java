...
public class PostProcessStageOptions {
    /**
     * The fragment shader to use. The default sampler2D uniforms are colorTexture and depthTexture.
     * The color texture is the output of rendering the scene or the previous stage. The depth texture is the
     * output from rendering the scene. The shader should contain one or both uniforms. There is also a vec2
     * varying named v_textureCoordinates that can be used to sample the textures.
     */
    @JsProperty
    public String fragmentShader;
    /**
     * An object whose properties will be used to set the shaders uniforms. The properties can be constant values or a function.
     ...
     * Default: {@link PostProcessStageSampleMode#NEAREST()}
     */
    @JsProperty
