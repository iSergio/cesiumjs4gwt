 ...
 */
public abstract class CesiumWidgetPanelAbstract extends SimplePanel {
    private final Configuration _configuration;
    private CesiumWidget _widget;

    public CesiumWidgetPanelAbstract(Configuration configuration) {
    ...
    protected void inject(final Element element) {
        ...
        Cesium.initialize(_configuration.getPath(), document, new Callback<Void, Exception>() {
            ...
            public void onSuccess(Void aVoid) {
                _widget = create(element);
            }
        });
    }

    public abstract CesiumWidget create(Element element);

    public CesiumWidget get() {
        return _widget;
    }
}
