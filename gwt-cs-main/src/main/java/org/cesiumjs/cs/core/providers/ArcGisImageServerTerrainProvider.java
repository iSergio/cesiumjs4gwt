...
public class ArcGisImageServerTerrainProvider implements TerrainProvider {
    ...
    /**
     * Gets the tiling scheme used by this provider. This function should not be called before {@link ArcGisImageServerTerrainProvider#ready} returns true.
     */
    @JsProperty
    public GeographicTilingScheme tilingScheme;

    @JsConstructor
    public ArcGisImageServerTerrainProvider() {}

    @JsConstructor
    public ArcGisImageServerTerrainProvider(ArcGisImageServerTerrainProviderOptions options) {}

    /**
     * Gets the maximum geometric error allowed in a tile at a given level. This function should not be called before
     * {@link ArcGisImageServerTerrainProvider#ready} returns true.
    ...
    /**
     * Requests the geometry for a given tile. This function should not be called before {@link ArcGisImageServerTerrainProvider#ready} returns true.
