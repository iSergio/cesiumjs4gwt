...
public class Fullscreen {
     ...
     * This event name is intended for use with addEventListener. In your event handler,
     * to determine if the browser is in fullscreen mode or not, use Fullscreen#fullscreen.
     */
    @JsProperty(name = "changeEventName")
    public static native String changeEventName();
    /**
     * The element that is currently fullscreen, if any. To simply check if the browser is in fullscreen mode or not,
     * use Fullscreen#fullscreen.
     */
    @JsProperty(name = "element")
    public static native Object element();
    /**
     * Determine whether the browser will allow an element to be made fullscreen, or not. For example, by default,
     * iframes cannot go fullscreen unless the containing page adds an "allowfullscreen" attribute (or prefixed equivalent).
     */
     ...
     * This event name is intended for use with addEventListener.
     */
    ...
    /**
     * Asynchronously exits fullscreen mode. If the browser is not currently in fullscreen, or if
     * fullscreen mode is not supported by the browser, does nothing.
     */
    @JsMethod
     ...
     * @return true if the browser supports the standard fullscreen API, false otherwise.
     */
    @JsMethod
