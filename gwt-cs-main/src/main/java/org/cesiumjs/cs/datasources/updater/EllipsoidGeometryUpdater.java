...
/**
 * A {@link GeometryUpdater} for ellipsoids. Clients do not normally create this class directly,
 * but instead rely on {@link org.cesiumjs.cs.datasources.DataSourceDisplay}.
 *
 * @author Serge Silaev aka iSergio <s.serge.b@gmail.com>
 */
@JsType(isNative = true, namespace = "Cesium", name = "EllipsoidGeometryUpdater")
public class EllipsoidGeometryUpdater extends GeometryUpdater {
    /**
