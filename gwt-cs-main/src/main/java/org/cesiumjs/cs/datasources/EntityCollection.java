...
public class EntityCollection {
    ...
    /**
     * An observable collection of {@link Entity} instances where each entity has a unique id.
     * @param object CompositeEntityCollection | DataSource The data source (or composite entity collection) which created this collection.
     */
    @JsConstructor
    ...
    /**
     * An observable collection of {@link Entity} instances where each entity has a unique id.
     * @param owner CompositeEntityCollection | DataSource The data source (or composite entity collection) which created this collection.
     */
    @JsConstructor
    ...
    @JsMethod
    public static native void collectionChangedEventCallback(EntityCollection collection, Entity[] added, Entity[] removed, Entity[] changed);
