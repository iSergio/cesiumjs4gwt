...
/**
 * A {@link GeometryUpdater} for ellipses. Clients do not normally create this class directly, but instead rely on {@link org.cesiumjs.cs.datasources.DataSourceDisplay}.
 *
 * @author Serge Silaev aka iSergio <s.serge.b@gmail.com>
 */
@JsType(isNative = true, namespace = "Cesium", name = "EllipseGeometryUpdater")
public class EllipseGeometryUpdater extends GeometryUpdater {
    /**
    ...
    /**
     * A {@link GeometryUpdater} for ellipses. Clients do not normally create this class directly,
     ...
     */
    @JsConstructor
    public EllipseGeometryUpdater(Entity entity, Scene scene) {
        super(entity, scene);
    }
}
